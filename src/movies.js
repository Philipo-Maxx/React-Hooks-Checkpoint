const movies_ = [
  {
    ...
    title: "Inception",
    description:
      "A skilled thief is given a chance to have his criminal history erased if he can successfully implant an idea into a target's subconscious.",
